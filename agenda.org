...
* Faceting, time series, transformations - w12s28 (4-Apr)
...
** Topics    
  ...
  * [ ] Topics: faceting, time series and transformations
...
* Boxplots, ridge plots, data presentation - w12s29 (6-Apr)

* *THERE IS NO CLASS ON FRIDAY APRIL 8*

  But there will be a substitute assignment of ca. 1 hour length, to
  be handed in by 3.50 pm.

* EDA with numerical data - w13s30/31 (11/13-Apr)
  * [ ] DataCamp review
  * [ ] Lab
* Numerical summaries - w14s32/33 (20/22-Apr)
  * [ ] DataCamp review
  * [ ] Lab
* C++ and R (Wyatt) - w15s34 (27-Apr)
* Data science on the command line (Ben) - w15s35 (29-Apr)
* Excel and R? Tableau? - w16s36 (2-May)
