...
** Overview
   ...
   | Assignment   | Set ~emacs~ init file                           |
   |              | Create ~.org~ file                              |
   |              | Run code in an ~.org~ file                      |
   | Assignment   | Reading ~2022 Data trends and predictions       |
   |              | Putting your summary thoughts in an ~.org~ file |
...
** Reading assignment
   ...
   * Prepare for discussion:
     - Distinguish quantitative and qualitative predictions
     - Try to get a (validated) feeling for the validity
     - Write a short summary in the form of an Org-mode file
