...
** ggplot2 and dplyr
   ...
   * [ ] In winter 2020 (DSC101) I gave an introductory lecture to
   ...
   * [ ] This workbook came from an Org-mode file that I have uploaded
   ...
   * [ ] In this advanced introductory class, we will instead dive
   ...
   * [ ] I say it once at the outset (and hopefully not too many
   ...
   * [ ] See also my notes on the "Tidyverse" and ggplot2 from the
...
* Test preparation / quiz 4-6 - w9s21 (11-Mar)
  ...
  * [ ] You find the materials of the past month in GitHub ([[https://github.com/birkenkrahe/ds205/tree/main/pdf][pdf/]])

  * [ ] Review of quiz 4-6

  * [ ] Review of DataCamp chapters "apply" and and "utilities"
  ...
  * [ ] Best way to prepare: practice "Intermediate R" in the DataCamp
