...
** Objectives
   ...
   * [ ] Get started with interactive Emacs notebooks
   * [ ] Save and load user-defined functions
   * [ ] Practice writing functions (system, stats)
   * [ ] Understand stats functions in R
   * [ ] Learn a new Emacs package or two
