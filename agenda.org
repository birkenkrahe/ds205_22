...
** News
   ...
   * Emacs package of the week: ~recentf~
...
** Emacs package of the week: how to display recent files
   ...
   * [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Key-Bindings.html][Customizing Key Bindings: GNU Emacs manual]] (also available inside
     Emacs: ~C-h i~ opens the Emacs info reader)
...
** Objectives
   ...
   * [ ] Learn a new Emacs package

** Warmup exercise: write a system function!
** Statistical functions
** Practice: write a statistical function!
** Next
