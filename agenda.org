...
* Writing functions - w6s13 - (02/14/22)
** News
...
** Overview
   ...
   |----------------------------+---------------------------------+---|
   | Practice Class assignments | Installing loading packages     |   |
...
** Objectives
   ...
   * [ ] Mark guest talk in your calendar (Fri 18-Feb) Derby 209
   
   * [ ] Understand how "class assignments" work

   * [ ] Complete a couple of class assignments
...
* NEXT Reviewing test 1 - w6s14 (02/16/22)
** Overview
...
** Test 1 results
   ...
   * Preparing such a test on paper and grading it while allowing for
     partial credit is a nightmare: future tests will be online in
     Schoology!

   * Plots: histogram, boxplot, density plot
