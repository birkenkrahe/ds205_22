...
** Objectives
   ...
   * [X] Run am R code block in your Org file
...
* w3s7 (01/28/22)
  ...
  2) [[file:~/Documents/GitHub/org/FAQ.org::Fixing the .emacs problem][Fixing the .emacs problem]]
  ...
  4) Finish [[file:assignments/org-mode/README.org::Creating and running R inside an Org-mode file][Org-mode assignment]]

  5) Submit results to GitHub as issue (ZIP) - by 11.59PM tonight
