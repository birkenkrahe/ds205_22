...
* Analysis COVID-19 DataCamp project - w11s25 (28-Mar/30 Mar)
...
* IN PROGRESS UpdateR, scatterplots, faceting - w11s25 (1-Apr)
...
** Preview: DataCamp course EDA in R
   ...
   * [ ] You find the datasets at the end of the course page
   * [ ] Read them into data frames using ~read_csv~ or ~read.csv~
   * [ ] Introduction of the contingency table function ~table~
   * [ ] Uses ~factor~ and ~levels~ (both function and attribute)
   * [ ] Presents different formats of bar charts with ~geom_bar~
   * [ ] Faceting with ~facet_wrap~

** Gapminder 2 - scatterplots and faceting

   * [ ] Download the gapminder directory from GDrive
   * [ ] Open gapminder.org

* NEXT time series, transformations - w11s26 (4-Apr)

* NEXT multimodal  distributions (6-Apr)

* *THERE IS NO CLASS ON FRIDAY APRIL 8*
