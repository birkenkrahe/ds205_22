...
*** Test 1 results
    ...
    * When checking the stats with R, I find different results. Why?[fn:2]
      ...
      : [1] "Sample: 13"
      :
      : [1] "Standard deviation: 2.69653447301592"
      :
      : [1] "Average: 70.3153846153846"
      :
...
** Objectives
   ...
   * Summarize main messages of the talk by Matthew Stewart
...
** TODO What did you think of the talk?
...
** IN PROGRESS Tidyverse vs base R
...
** IN PROGRESS ~ggplot2~
   ...
   * We're going to do a quick tour of ~ggplot2~.
...
** Concatenation and printing
   ...
   * ~cat~ (like the UNIX command) outputs object, concatenates, less
     conversion than ~print~.

* TODO Reading tables with ~read.table~
* TODO The ~apply~ family of functions
* References
