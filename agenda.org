...
* Change R download repo - w8s18 (4-Mar)

** News

   * Mid-term grades - Improve your grade with a project ([[https://github.com/birkenkrahe/org/blob/master/FAQ.org#how-can-i-improve-my-mid-term-grades][FAQ]])
   * I only realized today that I can dispense with GitHub

** Writing functions: set default R download repo

   * Download ~repos_nb.org~ from GDrive and get cracking!
   
** Code along: statistical functions

   * Code along = get the Org file from GDrive and code alongside me
     while I lecture to my heart's delight
...
* NEXT Tour of ~apply~ - w9s19 (7-Mar)     
** News
   ...
   * [ ] Emacs package of the week: Org Pomodoro Timer
