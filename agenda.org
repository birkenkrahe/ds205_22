...
** Objectives
   ...
   * [ ] Understand the implications of the 2022 DataCamp trend report
   * [ ] Understand and apply the scenario planning technique
   * [ ] Understand how to use Org-mode properly

** Next

   * Quiz 3 (Friday before class)
   * Test 1 (Wednesday next week)
   * Interactive R - conditionals and control flow
