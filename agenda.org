...
* NEXT Writing functions - w5s10 (02/07/22)
...
** Objectives
   ...
   * [ ] Review quiz 3 & how to study with DataCamp
   * [ ] Understand test conditions (Friday 11 Feb)
   * [ ] Understand how to write functions in R (lecture)

** Next

   * Interactive R notebook - Writing functions (problems)
   * Test 1 (Friday 11 Feb 3 PM)
