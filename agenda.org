...
* NEXT Scale and value transformations - w13s30/31 (11-Apr)

  * [ ] Review: Tidyverse Sceptic essay reading + writing assignment
  * [ ] Quiz 8 = DataCamp review + time series + faceting
  * [ ] Topic: scale and value transformations with ~gapminder~
  * [ ] Practice workbook ~gapminder4.org~ in [[https://drive.google.com/drive/folders/1GaE0iDWSoPexSrRUhZcKGyr8F2kSibWs?usp=sharing][GDrive]]

** Conceptual data science stuff

   * This completes our monthly "conceptual" series:
   ...
   * We met a fourth issue (interactive notebooks) in practice via
     Emacs - topic of my recent faculty colloquium talk ([[https://docs.google.com/presentation/d/1wA7sb41EjV6GP3oBEFsOiYnoe29WILtLJR2sHSfr6Fs/edit?usp=sharing][link]])
   
** Topics

   * Remember: ~ggplot2~ is actually not really part of the "Tidyverse"
   * [ ] Scale and value transformations (gapminder4.org in GDrive)
   * [ ] Review: DataCamp - EDA with R - categorical variables

* Boxplots and ridge plots - w14s32/33 (12-Apr)

  * [ ] Topic: boxplots and ridge plots with ~gapminder~    
  * [ ] Practice workbook ~gapminder5.org~ in [[https://drive.google.com/drive/folders/1GaE0iDWSoPexSrRUhZcKGyr8F2kSibWs?usp=sharing][GDrive]]
  * [ ] Resource: [[https://www.r-bloggers.com/2022/04/how-to-make-a-boxplot-in-r/][How to make a boxplot in R]] (Negoita, 2022)
