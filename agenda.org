...
* w3s6 (01/26/22)
** News - internships and scholarships
** Overview
   ...
   |----------+------------------------------------------------------+--------------|
   | Demo     | Creating an Emacs Org-mode file with code and run it | [[https://github.com/birkenkrahe/org/blob/master/emacs/tutor.org#create-an-org-mode-file][tutor.org]]    |
   |----------+------------------------------------------------------+--------------|
...
** Objectives
   ...
   * [ ] Understand DataCamp assignment
   * [ ] Create an Org file
   * [ ] Run am R code block in your Org file
