...
* General Course Information
  ...
  * Textbook: Exploratory Data Analysis Using R, by Ronald
    K. Pearson. CRC Press, 2019.
...
** Objectives
   ...
   the chapters of the book[fn:1]. You will practice using classroom
   assignments and weekly programming assignments in DataCamp[fn:2].
...
** Schedule and session content
   ...
   | DATE       | EDAR[fn:7] LECTURE/LAB               | DATACAMP ASSIGNMENT[fn:8]                                       | TEST[fn:9] |
   |------------+--------------------------------------+-----------------------------------------------------------+------------|
...
[fn:1]However, "R for Data Science" (r4ds) is not an easy book to read - it is
very condensed in some, and too expansive (for my taste) in other
places. But we'll try!

[fn:2]The course covers (almost) the entire "Data Scientist with R"
...
[fn:7]Chapter or subchapter in "Exploratory Data Analysis Using R" by
Pearson (CRC Press, 2019), includes classroom assignments in the form
of interactive notebooks.

[fn:8]The DataCamp assignments are heavily influenced by the
"Tidyverse" approach to data science with R as explained in "R for
Data Science" (r4ds) by [[https://r4ds.had.co.nz/introduction.html][Grolemund/Wickham (2017)]]. By contrast, the
classroom sessions will deal with Exploratory Data Analysis using base
R exclusively, as explained in the book with the same title by Pearson
(2019).
