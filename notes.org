...
** Log
   ...
   * See install.org in the org/emacs GitHub repo for a checklist of
...
* References
  ...
  vonjd (n.d). Why R for Data Science – and /Not/ Python! [blog]. [[https://blog.ephorie.de/why-r-for-data-science-and-not-python][URL:
  blog.ephorie.de.]]
